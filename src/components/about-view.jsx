              ...
              <div className='col-md-6 col-sm-12'>
                ...
                <div className='about-wrapper__info'>
                    <p className='about-wrapper__info-text'>
                            I am a Junior Web Developer living in Berlin and grew up in a rural area of NRW, Germany. While exploring myself in different fields all related to communication (e.g. pr, marketing, journalism), I always felt attracted to coding and building webpages. With the beginning of 2022 I overcame my fears of failing as a woman in tech and made my dream come true: I started learning JavaScript by myself, in August I expanded my knowledge with a 6-month Full-Stack Web Development program by CareerFoundry. In March I'm going to finish the course with an outcome of outstanding projects and a great deal of new knowledge – e.g. including MongoDB, Express, React, Node, and Angular. And if that's not enough I can tell I've never felt this passioned and fired up about anything before. Sounds huge? Yes it is!
